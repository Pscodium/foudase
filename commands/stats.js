...
module.exports.run = async (bot, message, args) => {
    message.channel.send(`= ESTATÍSTICAS =
• Bot        :: ${bot.user.tag}
• Developer  :: ! Ｐｓｃｏｄｉｕｍ#4483
• Cpu Usada  :: ${cpu}
• Memória usada  :: ${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)} MB
• Uptime     :: ${upDays} Dia(s), ${upHours} Hora(s), ${upMins} Minuto(s) e ${upSecs} Segundo(s)
• Usuários      :: ${bot.guilds.reduce((a, b) => a + b.memberCount, 0).toLocaleString()}
